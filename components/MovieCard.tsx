...
export default memo(function MovieCard({ movie }: { movie: Movie }) {
  return (
    ...
    >
      <div className="w-full aspect-[2/3] bg-[#1a1a20] rounded-xl relative overflow-hidden border border-white/10 shadow-lg group-hover:border-accent/60 group-active:border-accent transition-colors duration-200">
        <Image 
          src={movie.posterUrl} 
          alt={movie.title}
          fill
